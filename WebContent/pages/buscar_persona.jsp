	...
	<div class="row">
       <div class="col-lg-12">
	        ...
	        <div class="panel-heading">Busqueda Persona</div>
               ...
               <% if (request.getAttribute("perdni")==null) { %>      
               <div class="row">
               ...
               <div class="row">
                	...
                	<div class="col-lg-6">
                		<div class="form-group">
                          <label>DNI</label>
                          	<input class="form-control" type="number"  name="dni" id="dni" disabled="" value="<%=((Persona)session.getAttribute("perdni")).getDni()%>">
                          	
                        </div>
                        <div class="form-group">
                          <label>Nombre</label>
                          	<input class="form-control" type="text" name="nombre" id="nombre" value="<%=((Persona)session.getAttribute("perdni")).getNombre()%>">
                        </div>
                        <div class="form-group">
                          <label>Apellido</label>
                          	<input class="form-control" type="text" name="apellido" id="apellido" value="<%=((Persona)session.getAttribute("perdni")).getApellido()%>" >
                        </div>
                        <div class="form-group">
                          	<label>Estado</label>
                            	<div class="checkbox">
                                   <label>
                                     <input type="checkbox" value="admin" <% if(((Persona)session.getAttribute("perdni")).isHabilitado()){%> checked<%} %>>Habilitado
                                   </label>
                                </div>
                                </div>
                    </div>
                    <div class="col-lg-6">
                		<div class="form-group">
                          <label>Usuario</label>
                          	<input class="form-control" type="text" name="usuario" id="usuario" value="<%=((Persona)session.getAttribute("perdni")).getUss()%>" >
                        </div>
                        <div class="form-group">
                          <label>Contraseña</label>
                          	<input class="form-control" type="password" name="pass" id="pass" value="<%=((Persona)session.getAttribute("perdni")).getPass()%>">
                        </div>
                        <div class="form-group">
                        <label>Categoria</label>
                          <select class="form-control">
